        ...
        <p className="description">
          Get started by firse editing <code>pages/index.js</code>
            ...
            <div className="main__headings">
                <h1 className="mainHeadings__title">Work Experience</h1>
            </div>
            <div className="flex">
                <div className="mainSub__time">June, 2022 - <br/>present</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Full-stack Software Developer (Javascript, Typescript, React)</h2>
                    <h4 className="mainSub__subtitle">BOLT EARTH ev Charging Network, Bangalore</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">Jan, 2022 - <br/>Mar, 2022</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Product Management Intern</h2>
                    <h4 className="mainSub__subtitle">Zinnov Management Consulting, Bangalore</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">July, 2021 - <br/>Jan, 2022</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Thesis - Robotics Research Scholar</h2>
                    <h4 className="mainSub__subtitle">BITS PILANI, Hyderabad Campus</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
             ...
             <div className="flex">
                <div className="mainSub__time">May, 2021 - <br/>July, 2021</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Full-stack Developer (Typescript, Python)</h2>
                    <h4 className="mainSub__subtitle">ES Magico Experiences, Mumbai</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
                        <li>Frontend Web Application development in React.js.</li>
            ...
            <div className="flex">
                <div className="mainSub__time">Sep, 2019 - <br/>Feb, 2021</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Full-stack Web Developer</h2>
                    <h4 className="mainSub__subtitle">Shubhswapn Machine Tools Pvt. Ltd., Bhopal</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">May, 2018 - <br/>July, 2018</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Manufacturing Solutions</h2>
                    <h4 className="mainSub__subtitle">Rourkela Steel Plant, Rourkela</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">Aug, 2016 - <br/>Mar, 2017</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Web design and development intern</h2>
                    <h4 className="mainSub__subtitle">Pixelscapes India Pvt. Ltd. (Hyderabad)</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">Aug, 2016 - <br/>May, 2017</div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Business Development ( Network Expansion )</h2>
                    <h4 className="mainSub__subtitle">SmileMiddle, Hyderabad</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div style="margin-top: 50px;" className="main__headings">
                <h1>Projects</h1>
            </div>


            <div className="flex">
                <div className="mainSub__time">March, 2021 - </div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">"sw-insta" - Instagram Clone Multiplatform mobile application (realtime feed and posting)</h2>
                    <h4 className="mainSub__subtitle">React Native, Expo CLI, firebase and Redux</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">March, 2021 - </div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">"sw-signal" - Whatsapp Clone Multiplatform mobile application (realtime chatting and public channel creation)</h2>
                    <h4 className="mainSub__subtitle">React Native, Expo CLI, firebase and Redux</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">Feb, 2021 - </div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">"sw-facebook" - A react.js webApp cloning reatime posts and live feed of facebook.</h2>
                    <h4 className="mainSub__subtitle">ReactJs, firebase and Redux<span style="margin-left: 10px;" className="pills">https://sw-facebook.web.app/</span></h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
                        ...
                        <li>BEM classNameNaming convention - scalable app.</li>
            ...
            <div className="flex">
                <div className="mainSub__time">Feb, 2021 - </div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">"sw-whatsapp" - A react.js webApp cloning realtime chat, public channel creation and UI of WhatsApp web.</h2>
                    <h4 className="mainSub__subtitle">ReactJs, firebase and Redux<span style="margin-left: 10px;" className="pills">https://sw-whatsapp-6a9d8.web.app/</span></h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
                        <li>Firebase Firestore DB</li>
                        <li>Login with google (google auth)</li>
                        <li>REDUX/ react context API architecture</li>
                        ...
                        <li>BEM classNameNaming convention for easy scaling of the app</li>
                    </ul>
                </div>
            </div>
            <div className="flex">
                <div className="mainSub__time">Feb, 2021 - </div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">"sw-music" - Spotify Clone WebApp (realtime playlist updates from spotify account)</h2>
                    <h4 className="mainSub__subtitle">ReactJs, Spotify Developer Tools</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
            ...
            <div className="flex">
                <div className="mainSub__time">April, 2019 - </div>
                <div className="mainSub__desc">
                    <h2 className="mainSub__title">Medical History Management System - implementing Blockchain</h2>
                    <h4 className="mainSub__subtitle">Cryptography, Blockchain, Python, Flask framework</h4>
                    <ul className="mainSub__descList" style="list-style-position: inside;">
